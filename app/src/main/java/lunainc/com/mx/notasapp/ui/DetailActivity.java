        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (newName.trim().length() > 0 && newDesc.trim().length() > 0){
                    ...
                    new NotificationUtils().showBotification(DetailActivity.this, "Завдання оновлено", "Завдання успішно оновлено");


                }else{
                    new NotificationUtils().showBotification(DetailActivity.this, "Завдання не оновлено", "Ваше завдання не було оновлено, оскільки ви не заповнили всі обов'язкові поля.");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_info:
                Snackbar.make(parentContainer, "Розробка застосунку для планування справ з мінімалістичним дизайном", Snackbar.LENGTH_LONG)
                        .show();
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.button_positive, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        new NotificationUtils().showBotification(DetailActivity.this, "Завдання "+nameTaskStr+" видалено", "Завдання видалено "+nameTaskStr+" успішно");
                        goToBack();
                    }
                })
