        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.button_positive, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        new NotificationUtils().showBotification(MainActivity.this, "Видалені завдання", "Всі завдання були успішно видалені.");
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.button_positive, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        noteAdapter = new NoteAdapter(MainActivity.this, notas);
                        recyclerView.swapAdapter(noteAdapter, true);
                        new NotificationUtils().showBotification(MainActivity.this, "Завдання "+nota.getName()+" видалено", "Завдання видалено "+nota.getName()+" успішно");
